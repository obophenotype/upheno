...
1) Locate your odk yaml file and open it with your favourite text editor (src/ontology/upheno-odk.yaml)
...
4) Add the component to the edit file (src/ontology/upheno-edit.obo)
for .obo formats: 
